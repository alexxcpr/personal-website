export const translations = {
  en: {
    ...
    contact: {
      title: "Get In Touch",
      desc: "Interested in working together? Fill out the form or connect with me on social media.",
  ...
  ro: {
    ...
    contact: {
      ...
      desc: "Vrei să lucrăm împreună? Completează formularul sau contactează-mă pe rețelele sociale.",
      ...
      form: {
        ...
        error: "Eșec la trimiterea mesajului."
      }
    },
    footer: {
